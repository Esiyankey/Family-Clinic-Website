...
//             Open Monday–Thursday · Now accepting new patients
//           </p>
//         </div>
...
//               On-site lab services, vaccinations designed to
    ...
    <main>
      ...
      <section id="hero" className="relative overflow-hidden bg-slate-950 text-white">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-linear-to-r from-black/60 via-blue-900/50 to-blue-900/30" />
        </div>

 
        <div className="relative z-10 mx-auto flex min-h-[520px] max-w-7xl flex-col gap-10 px-4 py-16 md:min-h-[560px] md:px-6 lg:px-8 lg:flex-row lg:items-center">
         
          <div className="max-w-xl space-y-6" data-aos="fade-right" data-aos-duration="800">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em]">
              Family-centred primary care
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-semibold leading-tight">
            ...
            <p className="text-base md:text-lg text-slate-100/90">
              From routine checkups to long-term care, our team provides personalised, relationship-based medicine for
              all ages.
            </p>
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <Button asChild size="lg">
          ...
          <div className="mt-8 w-full max-w-md lg:mt-0 lg:ml-auto" data-aos="fade-left" data-aos-duration="800">
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur shadow-xl">
              <div className="relative mb-4 h-40 overflow-hidden rounded-xl">
                <Image src="/images/group-image.jpg" alt="Doctor with family" fill className="object-cover" />
                <div className="absolute inset-0 bg-linear-to-t from-black/55 to-transparent" />
                <div className="absolute bottom-3 left-3 text-sm text-white">
                  <p className="font-semibold">Board-certified providers</p>
                  <p className="text-xs text-blue-100">Trusted by families across our community</p>
                </div>
              </div>
              <p className="text-sm md:text-base text-slate-100">
                On-site lab services, vaccinations designed to keep your family close to home for most of their
                healthcare.
              </p>
            </div>
          </div>
        ...
        <div className="relative z-10 mx-auto -mt-6 max-w-7xl px-4 pb-12 md:px-6 lg:px-8">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {cards.map((card, index) => (
              <div
                key={card.title}
              ...
              >
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-600">{card.description}</p>
                <Link
                  href="/services"
                  className="mt-3 inline-flex items-center text-xs font-medium text-[#1a76d1] hover:underline"
                >
