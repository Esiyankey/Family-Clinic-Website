...
import { IoMdHome } from "react-icons/io";
import { FaUserDoctor, FaRegFaceSmileBeam } from "react-icons/fa6";
import { SlCalender } from "react-icons/sl";
import CountUp from "react-countup";
...
export const DataSection = () => {
  ...
  const DataCard = ({
    ...
    return (
      ...
      >
        <div className="border-2 border-white w-20 h-20 rounded-full flex justify-center items-center">
          {icon}
        </div>
        <div>
          <CountUp
